 ...
 * on 2017-05-04 at 21:31:53 UTC 
 * Modify at your own risk.
 */

package com.example.egonzalez.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   *
   * @param content the {@link com.example.egonzalez.myapplication.backend.myApi.model.MyBean}
   * @return the request
   */
  public SetJoke setJoke(com.example.egonzalez.myapplication.backend.myApi.model.MyBean content) throws java.io.IOException {
    SetJoke result = new SetJoke(content);
    initialize(result);
    return result;
  }

  public class SetJoke extends MyApiRequest<com.example.egonzalez.myapplication.backend.myApi.model.MyBean> {
     ...
     * @since 1.13
     */
    protected SetJoke(com.example.egonzalez.myapplication.backend.myApi.model.MyBean content) {
      super(MyApi.this, "POST", REST_PATH, content, com.example.egonzalez.myapplication.backend.myApi.model.MyBean.class);
    }
